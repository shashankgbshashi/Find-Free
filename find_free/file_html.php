...
<html>
    <style>
        body{
            ...
            background-repeat: no-repeat;height: 100%; background-color: rgb(246,242,242);
        }
...
<div class="info" style="padding-top:100px;margin: 20px;">
   ...
   <br> <button type="submit" name="submit_back" value="upload" class="btn btn-outline-primary">Upload</button>
